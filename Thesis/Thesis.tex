...
\mainmatter % Begin numeric (1,2,3...) page numbering
    ...
    \input{Sections/originalArchitecture.tex}

		\section{Problems Addressed}
		\label{se:problemsaddressed}
    \input{./Sections/problemsAddressed.tex}
